...
```
AI_Ripeness_Detector/
├── Data/                        # Dataset directory
│   ├── Test/                    # Test dataset
│   │   ├── Overripe/            # Overripe fruit test images
│   │   ├── Ripe/                # Ripe fruit test images
│   │   └── Unripe/              # Unripe fruit test images
│   └── Train/                   # Training dataset
│       ├── Overipe/             # Overripe fruit training images
│       ├── Ripe/                # Ripe fruit training images
│       └── Unripe/              # Unripe fruit training images
├── models/                      # Saved models and checkpoints
│   ├── ripeness_model.h5        # Trained model architecture
│   ├── ripeness_model.weights.h5 # Trained model weights
...
- Dataset provided by [Kaggle Fruit Ripeness Classification](https://www.kaggle.com/code/asadullahprl/fruit-ripeness-detection-transfer-learning/input)
